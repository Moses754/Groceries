...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" href="{{asset('')}}" ype="image/png">
    @stack('styles')
...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{asset('')}}" alt="logo" height="60" width="60">
    </div>
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{URL::to('veges')}}" class="nav-link {{ (request()->is('veg*')) ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-vegetable-head"></i>
                                    <p>
                                        veges
                                    </p>
                                </a>
